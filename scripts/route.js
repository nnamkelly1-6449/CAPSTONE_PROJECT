const routes = {
  ...
  "University Library": {
    ...
    steps: [
      "Start at Main Gate",
      "Walk straight",
      "Library is beside the Chapel on your left",
    ],
  },
  "University Chapel": {
    time: "Walking: ~3 mins | 200m",
    steps: [
      "From Main Gate, walk straight",
      "Chapel is the building with the cross, before the Library",
    ],
  },
  Cafeteria: {
    time: "Walking: ~6 mins | 400m",
    steps: [
      "Exit Main Gate area",
...
function showRoute() {
  ...
  if (route) {
    document.getElementById("route-time").innerText = From;
    {
      from;
    }
    To: {
